...
public static class ReqRespEmoji
{
    public static class Actors
    {
        ...
        public const string Monkey = "\U0001F435";
        ...
        public const string Server = "\U0001F5A5";

        public static readonly string[] All =
        [
            Cat, Dog, Rabbit, Fox, Panda,
            Koala, Tiger, Lion, Bear, Wolf,
            Monkey, Frog, Pig, Cow, Mouse,
            Hamster, Horse, Unicorn, Elephant, Penguin
        ];
    }

    public static class Statuses
    {
        public const string Sleep = "\U0001F634";
        public const string Pending = "\u23F3";
        public const string Stop = "\U0001F6AB";
        public const string InProgress = "\U0001F525";
        public const string Finished = "\U0001F3C1";
        public const string Canceled = "\u274C";
        public const string Completed = "\u2705";
        public const string Redirected = "\U0001F500";
    }
